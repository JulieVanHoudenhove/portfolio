        ...
        <>
            ...
            <footer id="contact" className="flex flex-col items-center bg-cream">
                ...
                <div className="flex flex-col gap-4 items-start w-full px-56 pb-20">
                    ...
                    <Link href="mailto:julie.vanhoudenhove@gmail.com" className="font-bold text-xs underline flex gap-2">Pour m'écrire un email de fifou<Image src="/images/open_in_new.svg" width={24} height={24} alt="Icône d'ouverture dans un nouvel onglet" /></Link>
                </div>
